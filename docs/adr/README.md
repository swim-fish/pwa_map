...
| [0012](0012-taipower-main-island-only.md)                   | Taipower MVP — main-island letters A–X only                                     | Superseded by 0036 | —              |
...
| [0029](0029-mobile-touch-target-and-notification-region.md) | Mobile touch-target floor + notification-region pattern                         | Accepted           | —              |
...
| [0034](0034-vitest-pool-routing.md)                         | Per-spec pool routing for `deploy-base-alignment` (test infrastructure)         | Accepted           | —              |
| [0035](0035-smart-promote-on-movement.md)                   | Smart preset — promote-on-movement cadence boost                                | Accepted           | 0033 (partial) |
| [0036](0036-taipower-grid-anchor-and-letter-table-fix.md)   | Taipower grid — 8×4 sparse table anchored at TWD67 easting 90 km (issue #8)     | Accepted           | 0012           |
